...
public class result3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        SharedPreferences sp111 = getApplication().getSharedPreferences("count_left111", Context.MODE_PRIVATE);
    ...
    public void openPuzzle(View view) {
        Intent intent = new Intent(result3.this, puzzle3.class);
        startActivity(intent);
    }

    public void open3d(View view) {
        Intent intent = new Intent(result3.this, wv3_3.class);
        startActivity(intent);
    }
}