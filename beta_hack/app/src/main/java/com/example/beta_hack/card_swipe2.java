...
public class card_swipe2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_card_swipe2);
        swipeAdapter();
    }
    private void swipeAdapter(){
        ...
        flingAdapterView.setFlingListener(new SwipeFlingAdapterView.onFlingListener() {
            ...
            public void onLeftCardExit(Object o) {
                Toast.makeText(card_swipe2.this,"нет",Toast.LENGTH_SHORT).show();
                count_left++;
            ...
            public void onRightCardExit(Object o) {
                Toast.makeText(card_swipe2.this,"да",Toast.LENGTH_SHORT).show();
                count_right++;
                if((count_left+count_right)==5){
                    finish();
                }
